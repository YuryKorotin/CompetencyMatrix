...
class DiagramEditableWidget extends StatefulWidget {
  DiagramEditableWidget(this._matrixId) : super();

  final BigInt _matrixId;

  @override
  KnowledgeEditableDiagramState createState() => KnowledgeEditableDiagramState(this._matrixId);
}

class KnowledgeEditableDiagramState extends State<DiagramEditableWidget> {
  BigInt _matrixId;
  ...
  KnowledgeEditableDiagramState(BigInt matrixId) {
  ...
  @override
  void initState() {
    _statistics.getLevelsStatisticsForDb().then((statisticsMap) =>
        setState(() {
